...
- "License" refers to the terms and conditions outlined in this document, which govern the use, modification, and distribution of the code or work that it covers.
- "Code" or "Work" refers to the software, code, or any other creative work that is covered by this License. This includes, but is not limited to, source code, compiled code, documentation, and any other materials that are associated with the code or work. The name of the project that this License covers is "ls_web", and is a web server written in Rust that serves files from a specified directory.
- "Author" refers to the individual who created the code or work that is covered by this License. The code that accompanies this License was created by Lucas Burlingham.
- "You" or "Your" refers to any individual or entity that uses, modifies, or distributes the code or work that is covered by this License.
...
- You must give credit where credit is due (a link back to the project this license protects when deployed on a public-facing site is sufficient) - [Romans 13:7](https://www.biblegateway.com/passage/?search=Romans%2013%3A7&version=NASB1995)
